...
public class Track extends Vehicle implements Runnable {

    private final double fuelVolume = 60;
    private final double fuelConsumption = 15;
    private double fuelLeft;
    public Semaphore sem;

    public Track(String name, Semaphore sem) {
        super(name, sem);
        this.sem = sem;
    }
